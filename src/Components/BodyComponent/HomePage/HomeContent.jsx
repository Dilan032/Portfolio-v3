...
function HomeContent() {
  return (
    <>
    <h1 className="fw-bold">Hi, I'm Dilan Kanishka</h1>
    <p>From Puttalam District, Sri Lanka</p>
    <p>
    ...
    <div className="shadow-sm rounded-3 border-0 bg-white p-2 text-center" style={{ "--bs-bg-opacity": "0.10" }}>
      <pre className="text-dark fw-semibold">~Turning dreams into digital reality~</pre>
    </div>
    </>
  )
}
